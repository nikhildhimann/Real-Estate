      ...
      <section className="py-24 bg-slate-50 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: ShieldCheck, title: "Verified Properties", desc: "Every listing is reviewed for accuracy and trust." },
              { icon: Users, title: "Expert Guidance", desc: "Get clear advice from experienced property specialists." },
              { icon: TrendingUp, title: "Best Price Deals", desc: "Find strong opportunities in desirable locations." },
              { icon: Clock, title: "Fast Support", desc: "Speak with an agent when it matters most." },
            ].map((feature, i) => (
              <motion.div
                key={feature.title}
                initial={{ opacity: 0, y: 30 }}
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              We help buyers, sellers, and investors make confident property decisions with trusted listings and expert support.
            </p>
